...
import es.miguelherrero.sunshine.ForecastAdapter
...
class WeatherListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        mWeatherList = view.findViewById(R.id.rv_weathers)
        ...
        mWeatherList.layoutManager = LinearLayoutManager(context)
    ...
    interface OnFragmentInteractionListener {
        fun onFragmentInteraction(weatherForDay: String)
    }
    ...
    private fun itemClicked(weatherForDay: String) {
        listener?.onFragmentInteraction(weatherForDay)
    }
}
